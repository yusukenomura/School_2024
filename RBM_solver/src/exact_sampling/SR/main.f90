...
program RBM_solver 
  ...
  do iteration = 1, Nstep 
    ...
    do ix = 1, D
      ...
      !
      ! summation over x for Smat
      !
      do k2 = 1, Nv
      do k1 = 1, Nv
        Smat(k1,k2) = Smat(k1,k2) + p_x * Ovec_loc_x(k1) * Ovec_loc_x(k2)  
      end do ! k1 
      end do ! k2 
    ...
    write(6,'(a,F20.10)') '   maximum change in W :', delW_max
  ...
  deallocate(seed,xlist,x,xp,Wirr,theta,thetap,gvec,Smat,Ovec,Ovec_loc_x)
end program 
